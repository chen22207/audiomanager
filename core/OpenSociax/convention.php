...
return  array(
    ...
    'DEFAULT_APPS'          =>  array('public','admin','page','wap','w3g'), //默认核心应用
    ...
    /* Session设置 */
    'SESSION_PREFIX'        => 'TSV3_',          // Session前缀 避免冲突
	...
	'TS_UPDATE_SITE'         =>	'http://demo.thinksns.com/t3',   // thinksns v3版本在线升级的服务环境地址
);
?>